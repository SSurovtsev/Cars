  ...
  template: `
    ...
    <div class="col-wrapper">
      <div class="col col-670">
        <div class="container">
          ...
          <div class="alert alert-primary">
            ...
            <h5><p>На 5-литровый твин-турбированный двигатель V8 – ошеломляющие 1100 лошадиные силы.
              А собственный электрический аккумулятор может добавить тебе около 50 километров экологически чистого пройденного пути.
              «Скорость стоит денег», что и доказывает цена машины, которая в среднем выходит в 1,9 млн долларов.</p></h5>
          </div>
      ...
      <div class="col col-250">
        <img class="pict" src="https://w.forfun.com/fetch/6e/6e852c5e8c59e1451a8bad04e5a71330.jpeg">
      </div>
    </div>

  `,
  styleUrls: ['./deteil-six.component.css']
})
export class DeteilSixComponent {
